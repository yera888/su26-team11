...
1. Customer (Jacob McGinniss):
    i. Create/Modify/Remove Customer Profile
        ...
        - Edit customer profile page to select genre prefrences with tags (Sci-Fi, Fantasy, Roamance etc.)
        - They can delete their account

    ii. View available services
        - Search Local Inventory by ISBN through sear bar and it will chech if that book exists in the database
    ...
    iv. Browse through Matched Books
        - View a personalized feed of books from the databade that were at least one book tag that matches the prefrences in customers profile
